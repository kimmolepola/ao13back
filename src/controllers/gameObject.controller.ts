import { getGameObject, saveGameState } from "../services/gameObject.service";
...
export const getGameObjectController = async (
  req: any,
  res: any,
  next: any
) => {
...
export const saveGameStateController = async (
  req: any,
  res: any,
  next: any
) => {
